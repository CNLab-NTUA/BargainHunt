...
import gr.ntua.cn.zannis.bargains.client.persistence.dao.GenericSkroutzDao;
 ...
 */
public class GenericSkroutzDaoImpl<T> extends GenericDaoImpl<T> implements GenericSkroutzDao<T> {
